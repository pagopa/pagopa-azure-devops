...
locals {
  ...
  tlscert-weudev-ecommerce-internal-dev-platform-pagopa-it-variables = {
    KEY_VAULT_SERVICE_CONNECTION = module.dev_ecommerce_tls_cert_service_conn.service_endpoint_name
  }
...
module "tlscert-weudev-ecommerce-internal-dev-platform-pagopa-it-cert_az" {
  ...
  service_connection_ids_authorization = [
    module.dev_ecommerce_tls_cert_service_conn.service_endpoint_id,
  ]
