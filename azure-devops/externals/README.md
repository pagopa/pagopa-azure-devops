...
| <a name="module_tlscert-prod-status-pagopa-gov-it-cert_az"></a> [tlscert-prod-status-pagopa-gov-it-cert\_az](#module\_tlscert-prod-status-pagopa-gov-it-cert\_az) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_tls_cert_federated | v5.5.0 |
...
| <a name="input_tlscert-prod-status-pagopa-gov-it"></a> [tlscert-prod-status-pagopa-gov-it](#input\_tlscert-prod-status-pagopa-gov-it) | n/a | `map` | <pre>{<br/>  "pipeline": {<br/>    "dns_record_name": "status",<br/>    "dns_zone_name": "pagopa.gov.it",<br/>    "dns_zone_resource_group": "pagopaorg-rg-prod",<br/>    "enable_tls_cert": true,<br/>    "path": "TLS-Certificates\\PROD",<br/>    "variables": {<br/>      "CERT_NAME_EXPIRE_SECONDS": "2592000",<br/>      "KEY_VAULT_NAME": "pagopa-p-kv"<br/>    },<br/>    "variables_secret": {}<br/>  },<br/>  "repository": {<br/>    "branch_name": "refs/heads/master",<br/>    "name": "le-azure-acme-tiny",<br/>    "organization": "pagopa",<br/>    "pipelines_path": "."<br/>  }<br/>}</pre> | no |
