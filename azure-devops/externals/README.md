...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_DEV-EXTERNALS-TLS-CERT-SERVICE-CONN"></a> [DEV-EXTERNALS-TLS-CERT-SERVICE-CONN](#module\_DEV-EXTERNALS-TLS-CERT-SERVICE-CONN) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_serviceendpoint_federated | v5.5.0 |
| <a name="module_PROD-EXTERNALS-TLS-CERT-SERVICE-CONN"></a> [PROD-EXTERNALS-TLS-CERT-SERVICE-CONN](#module\_PROD-EXTERNALS-TLS-CERT-SERVICE-CONN) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_serviceendpoint_federated | v5.5.0 |
| <a name="module_UAT-EXTERNALS-TLS-CERT-SERVICE-CONN"></a> [UAT-EXTERNALS-TLS-CERT-SERVICE-CONN](#module\_UAT-EXTERNALS-TLS-CERT-SERVICE-CONN) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_serviceendpoint_federated | v5.5.0 |
