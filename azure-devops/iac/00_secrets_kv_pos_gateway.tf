#
# pos_gateway KEYVAULT
#

module "pos_gateway_dev_secrets" {
  ...
  resource_group = local.dev_pos_gateway_key_vault_resource_group
  key_vault_name = local.dev_pos_gateway_key_vault_name
...
# module "pos_gateway_uat_secrets" {
#   source = "git::https://github.com/pagopa/terraform-azurerm-v3.git//key_vault_secrets_query?ref=v7.48.0"
...
#   resource_group = local.uat_pos_gateway_key_vault_resource_group
#   key_vault_name = local.uat_pos_gateway_key_vault_name
...
# module "pos_gateway_prod_secrets" {
#   source = "git::https://github.com/pagopa/terraform-azurerm-v3.git//key_vault_secrets_query?ref=v7.48.0"
...
#   resource_group = local.prod_pos_gateway_key_vault_resource_group
#   key_vault_name = local.prod_pos_gateway_key_vault_name
