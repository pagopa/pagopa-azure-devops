...
#   resource_group = local.dev_elk_key_vault_resource_group
#   key_vault_name = local.dev_elk_key_vault_name
...
#   resource_group = local.uat_elk_key_vault_resource_group
#   key_vault_name = local.uat_elk_key_vault_name
...
#   resource_group = local.prod_elk_key_vault_resource_group
#   key_vault_name = local.prod_elk_key_vault_name
