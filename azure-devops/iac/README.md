...
| <a name="input_iac_core"></a> [iac\_core](#input\_iac\_core) | ################################################# DO NOT COPY-PASTE THIS FILE use the new structured way to define the iac pipelines have a look at README.md ################################################# | `map` | <pre>{<br/>  "pipeline": {<br/>    "enable_code_review": true,<br/>    "enable_deploy": true,<br/>    "path_name": "core-infra"<br/>  },<br/>  "repository": {<br/>    "branch_name": "refs/heads/main",<br/>    "name": "pagopa-infra",<br/>    "organization": "pagopa",<br/>    "pipelines_path": ".devops",<br/>    "yml_prefix_name": "core"<br/>  }<br/>}</pre> | no |
| <a name="input_iac_next_core"></a> [iac\_next\_core](#input\_iac\_next\_core) | ################################################# DO NOT COPY-PASTE THIS FILE use the new structured way to define the iac pipelines have a look at README.md ################################################# | `map` | <pre>{<br/>  "pipeline": {<br/>    "enable_code_review": true,<br/>    "enable_deploy": true,<br/>    "path_name": "next-core-infra",<br/>    "pipeline_name_prefix": "next-core-infra"<br/>  },<br/>  "repository": {<br/>    "branch_name": "refs/heads/main",<br/>    "name": "pagopa-infra",<br/>    "organization": "pagopa",<br/>    "pipelines_path": ".devops",<br/>    "yml_prefix_name": "next-core"<br/>  }<br/>}</pre> | no |
