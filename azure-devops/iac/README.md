...
| <a name="module_fdr3_iac_db_archive_schema"></a> [fdr3\_iac\_db\_archive\_schema](#module\_fdr3\_iac\_db\_archive\_schema) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_generic | v7.0.0 |
...
| <a name="input_fdr3_iac"></a> [fdr3\_iac](#input\_fdr3\_iac) | ################################################# DO NOT COPY-PASTE THIS FILE use the new structured way to define the iac pipelines have a look at README.md ################################################# | `map` | <pre>{<br/>  "pipeline": {<br/>    "db_archive_schema": {<br/>      "name": "fdr-fase3-archive-db-schema-pipelines",<br/>      "pipeline_yml_filename": "fdr-fase3-archive-db-schema-pipelines.yml"<br/>    },<br/>    "db_migration": {<br/>      "name": "fdr-fase3-db-migration-pipelines",<br/>      "pipeline_yml_filename": "fdr-fase3-db-migration-pipelines.yml"<br/>    },<br/>    "db_schema": {<br/>      "name": "fdr-fase3-db-schema-pipelines",<br/>      "pipeline_yml_filename": "fdr-fase3-db-schema-pipelines.yml"<br/>    },<br/>    "path": "fdr3-infrastructure"<br/>  },<br/>  "repository": {<br/>    "branch_name": "refs/heads/main",<br/>    "name": "pagopa-fdr",<br/>    "organization": "pagopa",<br/>    "pipelines_path": ".devops",<br/>    "yml_prefix_name": "fdr-fase3"<br/>  }<br/>}</pre> | no |
