...
locals {
  ...
  dev_aca_key_vault_name  = "${local.prefix}-d-${local.domain}-kv"
  uat_aca_key_vault_name  = "${local.prefix}-u-${local.domain}-kv"
  prod_aca_key_vault_name = "${local.prefix}-p-${local.domain}-kv"

  dev_key_vault_resource_group  = "${local.prefix}-d-sec-rg"
  uat_key_vault_resource_group  = "${local.prefix}-u-sec-rg"
  prod_key_vault_resource_group = "${local.prefix}-p-sec-rg"

  dev_aca_key_vault_resource_group  = "${local.prefix}-d-${local.domain}-sec-rg"
  uat_aca_key_vault_resource_group  = "${local.prefix}-u-${local.domain}-sec-rg"
  prod_aca_key_vault_resource_group = "${local.prefix}-p-${local.domain}-sec-rg"
