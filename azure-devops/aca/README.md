...
| <a name="module_tlscert-weudev-aca-internal-dev-platform-pagopa-it-cert_az"></a> [tlscert-weudev-aca-internal-dev-platform-pagopa-it-cert\_az](#module\_tlscert-weudev-aca-internal-dev-platform-pagopa-it-cert\_az) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_tls_cert_federated | v4.2.1 |
| <a name="module_tlscert-weuprod-aca-internal-prod-platform-pagopa-it-cert_az"></a> [tlscert-weuprod-aca-internal-prod-platform-pagopa-it-cert\_az](#module\_tlscert-weuprod-aca-internal-prod-platform-pagopa-it-cert\_az) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_tls_cert_federated | v4.2.1 |
| <a name="module_tlscert-weuuat-aca-internal-uat-platform-pagopa-it-cert_az"></a> [tlscert-weuuat-aca-internal-uat-platform-pagopa-it-cert\_az](#module\_tlscert-weuuat-aca-internal-uat-platform-pagopa-it-cert\_az) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_tls_cert_federated | v4.2.1 |
