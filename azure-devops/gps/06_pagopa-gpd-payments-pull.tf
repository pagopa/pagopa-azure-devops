...
locals {
  ...
  pagopa-gpd-payments-pull-variables_secret_performance_test = {
    DEV_API_SUBSCRIPTION_KEY = module.common_dev_secrets.values["integration-test-subkey"].value
    # UAT_API_SUBSCRIPTION_KEY = module.common_dev_secrets.values["integration-test-subkey"].value
  }
