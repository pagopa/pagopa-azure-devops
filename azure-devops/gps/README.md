...
| <a name="module_pagopa-gpd-reporting-batch_deploy"></a> [pagopa-gpd-reporting-batch\_deploy](#module\_pagopa-gpd-reporting-batch\_deploy) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_deploy | v2.2.0 |
...
| <a name="module_pagopa-gpd-reporting-services_integration-test"></a> [pagopa-gpd-reporting-services\_integration-test](#module\_pagopa-gpd-reporting-services\_integration-test) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_generic | v2.6.3 |
...
| <a name="input_pagopa-gpd-payments"></a> [pagopa-gpd-payments](#input\_pagopa-gpd-payments) | n/a | `map` | <pre>{<br>  "pipeline": {<br>    "enable_code_review": true,<br>    "enable_deploy": true,<br>    "performance_test": {<br>      "enabled": true,<br>      "name": "performance-test-pipeline",<br>      "pipeline_yml_filename": "performance-test-pipelines.yml"<br>    },<br>    "sonarcloud": {<br>      "org": "pagopa",<br>      "project_key": "pagopa_pagopa-gpd-payments",<br>      "project_name": "pagopa-gpd-payments",<br>      "service_connection": "SONARCLOUD-SERVICE-CONN"<br>    }<br>  },<br>  "repository": {<br>    "branch_name": "refs/heads/main",<br>    "name": "pagopa-gpd-payments",<br>    "organization": "pagopa",<br>    "pipelines_path": ".devops",<br>    "yml_prefix_name": null<br>  }<br>}</pre> | no |
| <a name="input_pagopa-gpd-reporting-analysis"></a> [pagopa-gpd-reporting-analysis](#input\_pagopa-gpd-reporting-analysis) | n/a | `map` | <pre>{<br>  "pipeline": {<br>    "enable_code_review": true,<br>    "enable_deploy": true,<br>    "sonarcloud": {<br>      "org": "pagopa",<br>      "project_key": "pagopa_pagopa-gpd-reporting-analysis",<br>      "project_name": "pagopa-gpd-reporting-analysis",<br>      "service_connection": "SONARCLOUD-SERVICE-CONN"<br>    }<br>  },<br>  "repository": {<br>    "branch_name": "refs/heads/main",<br>    "name": "pagopa-gpd-reporting-analysis",<br>    "organization": "pagopa",<br>    "pipelines_path": ".devops",<br>    "yml_prefix_name": null<br>  }<br>}</pre> | no |
| <a name="input_pagopa-gpd-reporting-batch"></a> [pagopa-gpd-reporting-batch](#input\_pagopa-gpd-reporting-batch) | n/a | `map` | <pre>{<br>  "pipeline": {<br>    "enable_code_review": true,<br>    "enable_deploy": true,<br>    "sonarcloud": {<br>      "org": "pagopa",<br>      "project_key": "pagopa_pagopa-gpd-reporting-batch",<br>      "project_name": "pagopa-gpd-reporting-batch",<br>      "service_connection": "SONARCLOUD-SERVICE-CONN"<br>    }<br>  },<br>  "repository": {<br>    "branch_name": "refs/heads/main",<br>    "name": "pagopa-gpd-reporting-batch",<br>    "organization": "pagopa",<br>    "pipelines_path": ".devops",<br>    "yml_prefix_name": null<br>  }<br>}</pre> | no |
| <a name="input_pagopa-gpd-reporting-service"></a> [pagopa-gpd-reporting-service](#input\_pagopa-gpd-reporting-service) | n/a | `map` | <pre>{<br>  "pipeline": {<br>    "enable_code_review": true,<br>    "enable_deploy": true,<br>    "sonarcloud": {<br>      "org": "pagopa",<br>      "project_key": "pagopa_pagopa-gpd-reporting-service",<br>      "project_name": "pagopa-gpd-reporting-service",<br>      "service_connection": "SONARCLOUD-SERVICE-CONN"<br>    }<br>  },<br>  "repository": {<br>    "branch_name": "refs/heads/main",<br>    "name": "pagopa-gpd-reporting-service",<br>    "organization": "pagopa",<br>    "pipelines_path": ".devops",<br>    "yml_prefix_name": null<br>  }<br>}</pre> | no |
| <a name="input_pagopa-gpd-reporting-services"></a> [pagopa-gpd-reporting-services](#input\_pagopa-gpd-reporting-services) | n/a | `map` | <pre>{<br>  "pipeline": {<br>    "integration_test": {<br>      "enabled": true,<br>      "name": "gpd-reporting-services.integration-test",<br>      "pipeline_yml_filename": "integration-test-pipelines.yml"<br>    }<br>  },<br>  "repository": {<br>    "branch_name": "refs/heads/main",<br>    "name": "pagopa-debt-position",<br>    "organization": "pagopa",<br>    "pipelines_path": ".devops",<br>    "yml_prefix_name": null<br>  }<br>}</pre> | no |
