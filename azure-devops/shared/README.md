...
| <a name="module_pagopa-tkm-mock-circuit_code_review"></a> [pagopa-tkm-mock-circuit\_code\_review](#module\_pagopa-tkm-mock-circuit\_code\_review) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_code_review | v2.2.0 |
...
| <a name="input_pagopa-tkm-mock-circuit"></a> [pagopa-tkm-mock-circuit](#input\_pagopa-tkm-mock-circuit) | n/a | `map` | <pre>{<br>  "pipeline": {<br>    "enable_code_review": true,<br>    "enable_deploy": true,<br>    "sonarcloud": {<br>      "org": "pagopa",<br>      "project_key": "pagopa_tkm-mock-circuit",<br>      "project_name": "tkm-mock-circuit",<br>      "service_connection": "SONARCLOUD-SERVICE-CONN"<br>    }<br>  },<br>  "repository": {<br>    "branch_name": "refs/heads/main",<br>    "name": "tkm-mock-circuit",<br>    "organization": "pagopa",<br>    "pipelines_path": ".devops",<br>    "yml_prefix_name": null<br>  }<br>}</pre> | no |
