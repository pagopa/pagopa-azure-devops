...
| <a name="module_pagopa-search-transactions-fe_code_review"></a> [pagopa-search-transactions-fe\_code\_review](#module\_pagopa-search-transactions-fe\_code\_review) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_code_review | v5.1.1 |
| <a name="module_pagopa-search-transactions-fe_deploy"></a> [pagopa-search-transactions-fe\_deploy](#module\_pagopa-search-transactions-fe\_deploy) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_deploy | v4.2.1 |
...
| <a name="input_pagopa-anonymizer"></a> [pagopa-anonymizer](#input\_pagopa-anonymizer) | n/a | `map` | <pre>{<br/>  "pipeline": {<br/>    "performance_test": {<br/>      "enabled": true,<br/>      "name": "performance-test-pipeline",<br/>      "pipeline_yml_filename": "performance-test-pipelines.yml"<br/>    }<br/>  },<br/>  "repository": {<br/>    "branch_name": "refs/heads/main",<br/>    "name": "pagopa-anonymizer",<br/>    "organization": "pagopa",<br/>    "pipelines_path": ".devops",<br/>    "yml_prefix_name": null<br/>  }<br/>}</pre> | no |
...
| <a name="input_pagopa-search-transactions-fe"></a> [pagopa-search-transactions-fe](#input\_pagopa-search-transactions-fe) | n/a | `map` | <pre>{<br/>  "pipeline": {<br/>    "enable_code_review": true,<br/>    "enable_deploy": true,<br/>    "sonarcloud": {<br/>      "org": "pagopa",<br/>      "project_key": "pagopa_pagopa-search-transactions-fe",<br/>      "project_name": "pagopa-search-transactions-fe",<br/>      "service_connection": "SONARCLOUD-SERVICE-CONN"<br/>    }<br/>  },<br/>  "repository": {<br/>    "branch_name": "refs/heads/main",<br/>    "name": "pagopa-search-transactions-fe",<br/>    "organization": "pagopa",<br/>    "pipelines_path": ".devops",<br/>    "yml_prefix_name": null<br/>  }<br/>}</pre> | no |
