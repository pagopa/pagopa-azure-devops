...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_DEV-EBOLLO-TLS-CERT-SERVICE-CONN"></a> [DEV-EBOLLO-TLS-CERT-SERVICE-CONN](#module\_DEV-EBOLLO-TLS-CERT-SERVICE-CONN) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_serviceendpoint_federated | v9.2.1 |
| <a name="module_PROD-EBOLLO-TLS-CERT-SERVICE-CONN"></a> [PROD-EBOLLO-TLS-CERT-SERVICE-CONN](#module\_PROD-EBOLLO-TLS-CERT-SERVICE-CONN) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_serviceendpoint_federated | v9.2.1 |
| <a name="module_UAT-EBOLLO-TLS-CERT-SERVICE-CONN"></a> [UAT-EBOLLO-TLS-CERT-SERVICE-CONN](#module\_UAT-EBOLLO-TLS-CERT-SERVICE-CONN) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_serviceendpoint_federated | v9.2.1 |
...
| <a name="module_ebollo_dev_secrets"></a> [ebollo\_dev\_secrets](#module\_ebollo\_dev\_secrets) | ./.terraform/modules/__v3__/key_vault_secrets_query | n/a |
| <a name="module_ebollo_prod_secrets"></a> [ebollo\_prod\_secrets](#module\_ebollo\_prod\_secrets) | git::https://github.com/pagopa/terraform-azurerm-v3.git//key_vault_secrets_query | v8.22.0 |
| <a name="module_ebollo_uat_secrets"></a> [ebollo\_uat\_secrets](#module\_ebollo\_uat\_secrets) | ./.terraform/modules/__v3__/key_vault_secrets_query | n/a |
...
| <a name="module_pagopa-gps-mbd-service_performance_test"></a> [pagopa-gps-mbd-service\_performance\_test](#module\_pagopa-gps-mbd-service\_performance\_test) | ./.terraform/modules/__azdo__/azuredevops_build_definition_generic | n/a |
| <a name="module_pagopa-mbd-service_performance_test"></a> [pagopa-mbd-service\_performance\_test](#module\_pagopa-mbd-service\_performance\_test) | ./.terraform/modules/__azdo__/azuredevops_build_definition_generic | n/a |
| <a name="module_secrets"></a> [secrets](#module\_secrets) | ./.terraform/modules/__v3__/key_vault_secrets_query | n/a |
| <a name="module_tlscert-ebollo-itn-internal-dev-platform-pagopa-it-cert_az"></a> [tlscert-ebollo-itn-internal-dev-platform-pagopa-it-cert\_az](#module\_tlscert-ebollo-itn-internal-dev-platform-pagopa-it-cert\_az) | ./.terraform/modules/__azdo__/azuredevops_build_definition_tls_cert_federated | n/a |
| <a name="module_tlscert-ebollo-itn-internal-prod-platform-pagopa-it-cert_az"></a> [tlscert-ebollo-itn-internal-prod-platform-pagopa-it-cert\_az](#module\_tlscert-ebollo-itn-internal-prod-platform-pagopa-it-cert\_az) | ./.terraform/modules/__azdo__/azuredevops_build_definition_tls_cert_federated | n/a |
| <a name="module_tlscert-ebollo-itn-internal-uat-platform-pagopa-it-cert_az"></a> [tlscert-ebollo-itn-internal-uat-platform-pagopa-it-cert\_az](#module\_tlscert-ebollo-itn-internal-uat-platform-pagopa-it-cert\_az) | ./.terraform/modules/__azdo__/azuredevops_build_definition_tls_cert_federated | n/a |
...
| [azurerm_key_vault_access_policy.DEV-EBOLLO-TLS-CERT-SERVICE-CONN_kv_access_policy](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/key_vault_access_policy) | resource |
| [azurerm_key_vault_access_policy.PROD-EBOLLO-TLS-CERT-SERVICE-CONN_kv_access_policy](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/key_vault_access_policy) | resource |
| [azurerm_key_vault_access_policy.UAT-EBOLLO-TLS-CERT-SERVICE-CONN_kv_access_policy](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/key_vault_access_policy) | resource |
...
| <a name="input_pagopa-gps-mbd-service"></a> [pagopa-gps-mbd-service](#input\_pagopa-gps-mbd-service) | n/a | `map` | <pre>{<br/>  "pipeline": {<br/>    "performance_test": {<br/>      "enabled": true,<br/>      "name": "performance-test-pipeline",<br/>      "pipeline_yml_filename": "performance-test-pipelines.yml"<br/>    }<br/>  },<br/>  "repository": {<br/>    "branch_name": "refs/heads/main",<br/>    "name": "pagopa-gps-mbd-service",<br/>    "organization": "pagopa",<br/>    "pipelines_path": ".devops",<br/>    "yml_prefix_name": null<br/>  }<br/>}</pre> | no |
| <a name="input_pagopa-mbd-service"></a> [pagopa-mbd-service](#input\_pagopa-mbd-service) | n/a | `map` | <pre>{<br/>  "pipeline": {<br/>    "performance_test": {<br/>      "enabled": true,<br/>      "name": "performance-test-pipeline",<br/>      "pipeline_yml_filename": "performance-test-pipelines.yaml"<br/>    }<br/>  },<br/>  "repository": {<br/>    "branch_name": "refs/heads/main",<br/>    "name": "pagopa-mbd-service",<br/>    "organization": "pagopa",<br/>    "pipelines_path": ".devops",<br/>    "yml_prefix_name": null<br/>  }<br/>}</pre> | no |
...
| <a name="input_tlscert-ebollo-itn-internal-dev-platform-pagopa-it"></a> [tlscert-ebollo-itn-internal-dev-platform-pagopa-it](#input\_tlscert-ebollo-itn-internal-dev-platform-pagopa-it) | n/a | `map` | <pre>{<br/>  "pipeline": {<br/>    "dns_record_name": "ebollo.itn.internal",<br/>    "dns_zone_name": "dev.platform.pagopa.it",<br/>    "dns_zone_resource_group": "pagopa-d-vnet-rg",<br/>    "enable_tls_cert": true,<br/>    "path": "TLS-Certificates\\DEV",<br/>    "variables": {<br/>      "CERT_NAME_EXPIRE_SECONDS": "2592000",<br/>      "KEY_VAULT_NAME": "pagopa-d-itn-ebollo-kv"<br/>    },<br/>    "variables_secret": {}<br/>  },<br/>  "repository": {<br/>    "branch_name": "refs/heads/master",<br/>    "name": "le-azure-acme-tiny",<br/>    "organization": "pagopa",<br/>    "pipelines_path": "."<br/>  }<br/>}</pre> | no |
| <a name="input_tlscert-ebollo-itn-internal-prod-platform-pagopa-it"></a> [tlscert-ebollo-itn-internal-prod-platform-pagopa-it](#input\_tlscert-ebollo-itn-internal-prod-platform-pagopa-it) | n/a | `map` | <pre>{<br/>  "pipeline": {<br/>    "dns_record_name": "ebollo.itn.internal",<br/>    "dns_zone_name": "platform.pagopa.it",<br/>    "dns_zone_resource_group": "pagopa-p-vnet-rg",<br/>    "enable_tls_cert": true,<br/>    "path": "TLS-Certificates\\PROD",<br/>    "variables": {},<br/>    "variables_secret": {}<br/>  },<br/>  "repository": {<br/>    "branch_name": "refs/heads/master",<br/>    "name": "le-azure-acme-tiny",<br/>    "organization": "pagopa",<br/>    "pipelines_path": "."<br/>  }<br/>}</pre> | no |
| <a name="input_tlscert-ebollo-itn-internal-uat-platform-pagopa-it"></a> [tlscert-ebollo-itn-internal-uat-platform-pagopa-it](#input\_tlscert-ebollo-itn-internal-uat-platform-pagopa-it) | n/a | `map` | <pre>{<br/>  "pipeline": {<br/>    "dns_record_name": "ebollo.itn.internal",<br/>    "dns_zone_name": "uat.platform.pagopa.it",<br/>    "dns_zone_resource_group": "pagopa-u-vnet-rg",<br/>    "enable_tls_cert": true,<br/>    "path": "TLS-Certificates\\UAT",<br/>    "variables": {<br/>      "CERT_NAME_EXPIRE_SECONDS": "2592000",<br/>      "KEY_VAULT_NAME": "pagopa-u-itn-ebollo-kv"<br/>    },<br/>    "variables_secret": {}<br/>  },<br/>  "repository": {<br/>    "branch_name": "refs/heads/master",<br/>    "name": "le-azure-acme-tiny",<br/>    "organization": "pagopa",<br/>    "pipelines_path": "."<br/>  }<br/>}</pre> | no |
