...
| <a name="module_UAT-MOCK-TLS-CERT-SERVICE-CONN"></a> [UAT-MOCK-TLS-CERT-SERVICE-CONN](#module\_UAT-MOCK-TLS-CERT-SERVICE-CONN) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_serviceendpoint_federated | v4.2.1 |
...
| <a name="module_mock_uat_secrets"></a> [mock\_uat\_secrets](#module\_mock\_uat\_secrets) | git::https://github.com/pagopa/terraform-azurerm-v3.git//key_vault_secrets_query | v7.30.0 |
...
| <a name="module_tlscert-weuuat-mock-internal-uat-platform-pagopa-it-cert_az"></a> [tlscert-weuuat-mock-internal-uat-platform-pagopa-it-cert\_az](#module\_tlscert-weuuat-mock-internal-uat-platform-pagopa-it-cert\_az) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_tls_cert_federated | v5.0.0 |
...
| [azurerm_key_vault_access_policy.UAT-MOCK-TLS-CERT-SERVICE-CONN_kv_access_policy](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/key_vault_access_policy) | resource |
...
| <a name="input_tlscert-weuuat-mock-internal-uat-platform-pagopa-it"></a> [tlscert-weuuat-mock-internal-uat-platform-pagopa-it](#input\_tlscert-weuuat-mock-internal-uat-platform-pagopa-it) | n/a | `map` | <pre>{<br/>  "pipeline": {<br/>    "dns_record_name": "weuuat.mock.internal",<br/>    "dns_zone_name": "uat.platform.pagopa.it",<br/>    "dns_zone_resource_group": "pagopa-u-vnet-rg",<br/>    "enable_tls_cert": true,<br/>    "path": "TLS-Certificates\\UAT",<br/>    "variables": {<br/>      "CERT_NAME_EXPIRE_SECONDS": "2592000",<br/>      "KEY_VAULT_NAME": "pagopa-u-mock-kv"<br/>    },<br/>    "variables_secret": {}<br/>  },<br/>  "repository": {<br/>    "branch_name": "refs/heads/master",<br/>    "name": "le-azure-acme-tiny",<br/>    "organization": "pagopa",<br/>    "pipelines_path": "."<br/>  }<br/>}</pre> | no |
