...
| <a name="input_pipeline_environments_extra"></a> [pipeline\_environments\_extra](#input\_pipeline\_environments\_extra) | List of environments pipeline to create | `list(any)` | <pre>[<br>  "INT",<br>  "PRF"<br>]</pre> | no |
