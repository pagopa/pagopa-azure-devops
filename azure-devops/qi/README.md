...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_DEV-QI-TLS-CERT-SERVICE-CONN"></a> [DEV-QI-TLS-CERT-SERVICE-CONN](#module\_DEV-QI-TLS-CERT-SERVICE-CONN) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_serviceendpoint_federated | v4.2.1 |
| <a name="module_PROD-QI-TLS-CERT-SERVICE-CONN"></a> [PROD-QI-TLS-CERT-SERVICE-CONN](#module\_PROD-QI-TLS-CERT-SERVICE-CONN) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_serviceendpoint_federated | v4.2.1 |
| <a name="module_UAT-QI-TLS-CERT-SERVICE-CONN"></a> [UAT-QI-TLS-CERT-SERVICE-CONN](#module\_UAT-QI-TLS-CERT-SERVICE-CONN) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_serviceendpoint_federated | v4.2.1 |
...
| <a name="module_pagopa-accounting-reconciliation-bdi-ingestion_code_review"></a> [pagopa-accounting-reconciliation-bdi-ingestion\_code\_review](#module\_pagopa-accounting-reconciliation-bdi-ingestion\_code\_review) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_code_review | v5.1.1 |
| <a name="module_pagopa-accounting-reconciliation-bdi-ingestion_deploy"></a> [pagopa-accounting-reconciliation-bdi-ingestion\_deploy](#module\_pagopa-accounting-reconciliation-bdi-ingestion\_deploy) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_deploy | v4.2.1 |
| <a name="module_pagopa-qi-fdr-kpi-service_code_review"></a> [pagopa-qi-fdr-kpi-service\_code\_review](#module\_pagopa-qi-fdr-kpi-service\_code\_review) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_code_review | v5.1.1 |
| <a name="module_pagopa-qi-fdr-kpi-service_deploy"></a> [pagopa-qi-fdr-kpi-service\_deploy](#module\_pagopa-qi-fdr-kpi-service\_deploy) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_deploy | v4.2.1 |
| <a name="module_qi_dev_secrets"></a> [qi\_dev\_secrets](#module\_qi\_dev\_secrets) | git::https://github.com/pagopa/terraform-azurerm-v3.git//key_vault_secrets_query | v7.30.0 |
...
| <a name="input_pagopa-accounting-reconciliation-bdi-ingestion"></a> [pagopa-accounting-reconciliation-bdi-ingestion](#input\_pagopa-accounting-reconciliation-bdi-ingestion) | n/a | `map` | <pre>{<br/>  "pipeline": {<br/>    "enable_code_review": true,<br/>    "enable_deploy": true,<br/>    "sonarcloud": {<br/>      "org": "pagopa",<br/>      "project_key": "pagopa_pagopa-accounting-reconciliation-bdi-ingestion",<br/>      "project_name": "pagopa-accounting-reconciliation-bdi-ingestion",<br/>      "service_connection": "SONARCLOUD-SERVICE-CONN"<br/>    }<br/>  },<br/>  "repository": {<br/>    "branch_name": "refs/heads/main",<br/>    "name": "pagopa-accounting-reconciliation-bdi-ingestion",<br/>    "organization": "pagopa",<br/>    "pipelines_path": ".devops",<br/>    "yml_prefix_name": null<br/>  }<br/>}</pre> | no |
| <a name="input_pagopa-qi-fdr-kpi-service"></a> [pagopa-qi-fdr-kpi-service](#input\_pagopa-qi-fdr-kpi-service) | n/a | `map` | <pre>{<br/>  "pipeline": {<br/>    "enable_code_review": true,<br/>    "enable_deploy": true,<br/>    "sonarcloud": {<br/>      "org": "pagopa",<br/>      "project_key": "pagopa_pagopa-qi-fdr-kpi-service",<br/>      "project_name": "pagopa-qi-fdr-kpi-service",<br/>      "service_connection": "SONARCLOUD-SERVICE-CONN"<br/>    }<br/>  },<br/>  "repository": {<br/>    "branch_name": "refs/heads/main",<br/>    "name": "pagopa-qi-fdr-kpi-service",<br/>    "organization": "pagopa",<br/>    "pipelines_path": ".devops",<br/>    "yml_prefix_name": null<br/>  }<br/>}</pre> | no |
