...
#   service_account {
#     # base64 values
#     token   = module.secrets.values["pagopa-p-weu-prod-aks-azure-devops-sa-token"].value
#     ca_cert = module.secrets.values["pagopa-p-weu-prod-aks-azure-devops-sa-cacrt"].value
#   }
# }
