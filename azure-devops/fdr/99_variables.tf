...
locals {
  ...
  # 🔐 KV DOMAIN
  dev_fdr_key_vault_name  = "${local.prefix}-d-${local.domain}-kv"
  uat_fdr_key_vault_name  = "${local.prefix}-u-${local.domain}-kv"
  prod_fdr_key_vault_name = "${local.prefix}-p-${local.domain}-kv"

  dev_fdr_key_vault_resource_group  = "${local.prefix}-d-${local.domain}-sec-rg"
  uat_fdr_key_vault_resource_group  = "${local.prefix}-u-${local.domain}-sec-rg"
  prod_fdr_key_vault_resource_group = "${local.prefix}-p-${local.domain}-sec-rg"
