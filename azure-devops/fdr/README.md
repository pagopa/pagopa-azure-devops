...
| <a name="module_pagopa-reporting-fdr_deploy"></a> [pagopa-reporting-fdr\_deploy](#module\_pagopa-reporting-fdr\_deploy) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_deploy | v4.2.1 |
