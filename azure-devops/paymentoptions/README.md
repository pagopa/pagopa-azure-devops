...
| <a name="module_PROD-PAYOPT-TLS-CERT-SERVICE-CONN"></a> [PROD-PAYOPT-TLS-CERT-SERVICE-CONN](#module\_PROD-PAYOPT-TLS-CERT-SERVICE-CONN) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_serviceendpoint_federated | v9.2.1 |
...
| <a name="module_payopt_prod_secrets"></a> [payopt\_prod\_secrets](#module\_payopt\_prod\_secrets) | git::https://github.com/pagopa/terraform-azurerm-v3.git//key_vault_secrets_query | v8.22.0 |
...
| <a name="module_tlscert-payopt-itn-internal-prod-platform-pagopa-it-cert_az"></a> [tlscert-payopt-itn-internal-prod-platform-pagopa-it-cert\_az](#module\_tlscert-payopt-itn-internal-prod-platform-pagopa-it-cert\_az) | ./.terraform/modules/__azdo__/azuredevops_build_definition_tls_cert_federated | n/a |
...
| [azurerm_key_vault_access_policy.PROD-PAYOPT-TLS-CERT-SERVICE-CONN_kv_access_policy](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/key_vault_access_policy) | resource |
...
| <a name="input_pagopa-payment-options-service"></a> [pagopa-payment-options-service](#input\_pagopa-payment-options-service) | n/a | `map` | <pre>{<br/>  "pipeline": {<br/>    "performance_test": {<br/>      "enabled": true,<br/>      "name": "performance-test-pipeline",<br/>      "pipeline_yml_filename": "performance-test-pipelines.yml"<br/>    }<br/>  },<br/>  "repository": {<br/>    "branch_name": "refs/heads/main",<br/>    "name": "pagopa-payment-options-service",<br/>    "organization": "pagopa",<br/>    "pipelines_path": ".devops",<br/>    "yml_prefix_name": null<br/>  }<br/>}</pre> | no |
...
| <a name="input_tlscert-payopt-itn-internal-prod-platform-pagopa-it"></a> [tlscert-payopt-itn-internal-prod-platform-pagopa-it](#input\_tlscert-payopt-itn-internal-prod-platform-pagopa-it) | n/a | `map` | <pre>{<br/>  "pipeline": {<br/>    "dns_record_name": "payopt.itn.internal",<br/>    "dns_zone_name": "platform.pagopa.it",<br/>    "dns_zone_resource_group": "pagopa-p-vnet-rg",<br/>    "enable_tls_cert": true,<br/>    "path": "TLS-Certificates\\PROD",<br/>    "variables": {<br/>      "CERT_NAME_EXPIRE_SECONDS": "2592000",<br/>      "KEY_VAULT_NAME": "pagopa-p-itn-payopt-kv"<br/>    },<br/>    "variables_secret": {}<br/>  },<br/>  "repository": {<br/>    "branch_name": "refs/heads/master",<br/>    "name": "le-azure-acme-tiny",<br/>    "organization": "pagopa",<br/>    "pipelines_path": "."<br/>  }<br/>}</pre> | no |
