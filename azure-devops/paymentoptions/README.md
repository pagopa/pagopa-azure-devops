...
| <a name="module_UAT-PAYOPT-TLS-CERT-SERVICE-CONN"></a> [UAT-PAYOPT-TLS-CERT-SERVICE-CONN](#module\_UAT-PAYOPT-TLS-CERT-SERVICE-CONN) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_serviceendpoint_federated | v9.0.0 |
...
| <a name="module_payopt_uat_secrets"></a> [payopt\_uat\_secrets](#module\_payopt\_uat\_secrets) | git::https://github.com/pagopa/terraform-azurerm-v3.git//key_vault_secrets_query | v8.22.0 |
...
| <a name="module_tlscert-payopt-itn-internal-uat-platform-pagopa-it-cert_az"></a> [tlscert-payopt-itn-internal-uat-platform-pagopa-it-cert\_az](#module\_tlscert-payopt-itn-internal-uat-platform-pagopa-it-cert\_az) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_tls_cert_federated | v9.0.0 |
