...
locals {
  ...
  pagopa-selfcare-frontend-variables_deploy = {
    ...
    dev_resource_group_azure            = "pagopa-d-weu-selfcare-selfcare-fe-rg"
    ...
    dev_react_app_url_storage           = "https://pagopadweuselfcareselfcaresa.z6.web.core.windows.net/"
    ...
    prod_resource_group_azure            = "pagopa-p-weu-selfcare-selfcare-fe-rg"
    ...
    prod_react_app_url_storage           = "https://pagopapweuselfcareselfcaresa.z6.web.core.windows.net/"
    ...
    prod_react_app_url_fe_token_exchange = "https://dev.selfcare.pagopa.it/token-exchange"
    prod_react_app_url_api_token         = "https://api.dev.platform.pagopa.it/api/token/token"
  }
  # deploy secrets
