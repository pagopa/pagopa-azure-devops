variable "tlscert-weudev-selfcare-internal-dev-platform-pagopa-it" {
  default = {
    repository = {
      organization   = "pagopa"
    ...
    pipeline = {
      ...
      dns_record_name         = "weudev.selfcare.internal"
...
locals {
  ...
  tlscert-weudev-selfcare-internal-dev-platform-pagopa-it-variables_secret = {
  }
}

module "tlscert-weudev-selfcare-internal-dev-platform-pagopa-it-cert_az" {
  ...
  dns_record_name         = var.tlscert-weudev-selfcare-internal-dev-platform-pagopa-it.pipeline.dns_record_name
  dns_zone_name           = var.tlscert-weudev-selfcare-internal-dev-platform-pagopa-it.pipeline.dns_zone_name
  dns_zone_resource_group = var.tlscert-weudev-selfcare-internal-dev-platform-pagopa-it.pipeline.dns_zone_resource_group
  tenant_id               = local.tlscert-weudev-selfcare-internal-dev-platform-pagopa-it.tenant_id
  ...
  variables = merge(
    var.tlscert-weudev-selfcare-internal-dev-platform-pagopa-it.pipeline.variables,
    local.tlscert-weudev-selfcare-internal-dev-platform-pagopa-it-variables,
  )

  variables_secret = merge(
    var.tlscert-weudev-selfcare-internal-dev-platform-pagopa-it.pipeline.variables_secret,
    local.tlscert-weudev-selfcare-internal-dev-platform-pagopa-it-variables_secret,
  )
