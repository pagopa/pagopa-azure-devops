...
| <a name="module_PROD-WALLET-TLS-CERT-SERVICE-CONN"></a> [PROD-WALLET-TLS-CERT-SERVICE-CONN](#module\_PROD-WALLET-TLS-CERT-SERVICE-CONN) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_serviceendpoint_federated | v4.2.1 |
...
| <a name="module_tlscert-itnprod-pay-wallet-internal-prod-platform-pagopa-it-cert_az"></a> [tlscert-itnprod-pay-wallet-internal-prod-platform-pagopa-it-cert\_az](#module\_tlscert-itnprod-pay-wallet-internal-prod-platform-pagopa-it-cert\_az) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_tls_cert_federated | v5.0.0 |
...
| <a name="module_tlscert-prod-payment-wallet-pagopa-it-cert_az"></a> [tlscert-prod-payment-wallet-pagopa-it-cert\_az](#module\_tlscert-prod-payment-wallet-pagopa-it-cert\_az) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_tls_cert_federated | v5.0.0 |
...
| <a name="module_wallet_prod_secrets"></a> [wallet\_prod\_secrets](#module\_wallet\_prod\_secrets) | git::https://github.com/pagopa/terraform-azurerm-v3.git//key_vault_secrets_query | v7.30.0 |
...
| [azurerm_key_vault_access_policy.PROD-WALLET-TLS-CERT-SERVICE-CONN_kv_access_policy](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/key_vault_access_policy) | resource |
...
| <a name="input_tlscert-itnprod-pay-wallet-internal-prod-platform-pagopa-it"></a> [tlscert-itnprod-pay-wallet-internal-prod-platform-pagopa-it](#input\_tlscert-itnprod-pay-wallet-internal-prod-platform-pagopa-it) | n/a | `map` | <pre>{<br>  "pipeline": {<br>    "dns_record_name": "itnprod.pay-wallet.internal",<br>    "dns_zone_name": "platform.pagopa.it",<br>    "dns_zone_resource_group": "pagopa-p-vnet-rg",<br>    "enable_tls_cert": true,<br>    "path": "TLS-Certificates\\PROD",<br>    "variables": {<br>      "CERT_NAME_EXPIRE_SECONDS": "2592000",<br>      "KEY_VAULT_NAME": "pagopa-p-pay-wallet-kv"<br>    },<br>    "variables_secret": {}<br>  },<br>  "repository": {<br>    "branch_name": "refs/heads/master",<br>    "name": "le-azure-acme-tiny",<br>    "organization": "pagopa",<br>    "pipelines_path": "."<br>  }<br>}</pre> | no |
...
| <a name="input_tlscert-prod-payment-wallet-pagopa-it"></a> [tlscert-prod-payment-wallet-pagopa-it](#input\_tlscert-prod-payment-wallet-pagopa-it) | n/a | `map` | <pre>{<br>  "pipeline": {<br>    "dns_record_name": "",<br>    "dns_zone_name": "payment-wallet.pagopa.it",<br>    "dns_zone_resource_group": "pagopa-p-vnet-rg",<br>    "enable_tls_cert": true,<br>    "path": "TLS-Certificates\\PROD",<br>    "variables": {<br>      "CERT_NAME_EXPIRE_SECONDS": "2592000",<br>      "KEY_VAULT_NAME": "pagopa-p-pay-wallet-kv"<br>    },<br>    "variables_secret": {}<br>  },<br>  "repository": {<br>    "branch_name": "refs/heads/master",<br>    "name": "le-azure-acme-tiny",<br>    "organization": "pagopa",<br>    "pipelines_path": "."<br>  }<br>}</pre> | no |
