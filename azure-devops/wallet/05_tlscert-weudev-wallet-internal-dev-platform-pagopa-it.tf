variable "tlscert-weudev-wallet-internal-dev-platform-pagopa-it" {
  default = {
    repository = {
      organization   = "pagopa"
    ...
    pipeline = {
      ...
      dns_record_name         = "weudev.wallet.internal"
...
module "tlscert-weudev-wallet-internal-dev-platform-pagopa-it-cert_az" {
  ...
  dns_zone_resource_group = var.tlscert-weudev-wallet-internal-dev-platform-pagopa-it.pipeline.dns_zone_resource_group
  tenant_id               = local.tlscert-weudev-wallet-internal-dev-platform-pagopa-it.tenant_id
  subscription_name       = local.tlscert-weudev-wallet-internal-dev-platform-pagopa-it.subscription_name
  subscription_id         = local.tlscert-weudev-wallet-internal-dev-platform-pagopa-it.subscription_id
  ...
  variables = merge(
    var.tlscert-weudev-wallet-internal-dev-platform-pagopa-it.pipeline.variables,
    local.tlscert-weudev-wallet-internal-dev-platform-pagopa-it-variables,
  )

  variables_secret = merge(
    var.tlscert-weudev-wallet-internal-dev-platform-pagopa-it.pipeline.variables_secret,
    local.tlscert-weudev-wallet-internal-dev-platform-pagopa-it-variables_secret,
  )
