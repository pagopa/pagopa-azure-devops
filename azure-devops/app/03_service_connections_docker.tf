...
resource "azuredevops_serviceendpoint_azurecr" "aks_cr_itn_dev" {
  ...
  service_endpoint_name = local.srv_endpoint_name_aks_cr_itn_dev
...
resource "azuredevops_serviceendpoint_azurecr" "aks_cr_itn_uat" {
  ...
  service_endpoint_name = local.srv_endpoint_name_aks_cr_itn_uat
  azurecr_name          = local.aks_cr_rg_name_uat
...
resource "azuredevops_serviceendpoint_azurecr" "aks_cr_itn_prod" {
  ...
  service_endpoint_name = local.srv_endpoint_name_aks_cr_itn_prod
  azurecr_name          = local.aks_cr_rg_name_prod
