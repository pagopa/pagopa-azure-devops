...
module "tlscert-weudev-afm-internal-dev-platform-pagopa-it-cert_az" {
  ...
  name       = "${var.tlscert-weudev-afm-internal-dev-platform-pagopa-it.pipeline.dns_record_name}.${var.tlscert-weudev-afm-internal-dev-platform-pagopa-it.pipeline.dns_zone_name}"
  #tfsec:ignore:GEN003
