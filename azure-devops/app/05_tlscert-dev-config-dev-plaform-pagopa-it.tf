variable "tlscert-dev-config-dev-platform-pagopa-it" {
  default = {
    repository = {
      organization   = "pagopa"
...
locals {
  ...
  tlscert-dev-config-dev-platform-pagopa-it-variables = {
    KEY_VAULT_SERVICE_CONNECTION = module.DEV-TLS-CERT-SERVICE-CONN.service_endpoint_name
  }
  tlscert-dev-config-dev-platform-pagopa-it-variables_secret = {
  }
}
...
module "tlscert-dev-config-dev-platform-pagopa-it-cert_az" {
  ...
  dns_record_name         = var.tlscert-dev-config-dev-platform-pagopa-it.pipeline.dns_record_name
  dns_zone_name           = var.tlscert-dev-config-dev-platform-pagopa-it.pipeline.dns_zone_name
  dns_zone_resource_group = var.tlscert-dev-config-dev-platform-pagopa-it.pipeline.dns_zone_resource_group
  tenant_id               = local.tlscert-dev-config-dev-platform-pagopa-it.tenant_id
  subscription_name       = local.tlscert-dev-config-dev-platform-pagopa-it.subscription_name
  subscription_id         = local.tlscert-dev-config-dev-platform-pagopa-it.subscription_id
