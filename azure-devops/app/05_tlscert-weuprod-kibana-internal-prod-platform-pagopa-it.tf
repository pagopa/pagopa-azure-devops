...
module "tlscert-weuprod-kibana-internal-prod-platform-pagopa-it-cert_az" {
  ...
  name       = "${var.tlscert-weuprod-kibana-internal-prod-platform-pagopa-it.pipeline.dns_record_name}.${var.tlscert-weuprod-kibana-internal-prod-platform-pagopa-it.pipeline.dns_zone_name}"
  #tfsec:ignore:GEN003
