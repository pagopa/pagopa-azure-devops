...
resource "azurerm_key_vault_access_policy" "DEV-BIZEVENTS-TLS-CERT-SERVICE-CONN_kv_access_policy" {
...
resource "azurerm_key_vault_access_policy" "UAT-BIZEVENTS-TLS-CERT-SERVICE-CONN_kv_access_policy" {
...
resource "azurerm_key_vault_access_policy" "PROD-BIZEVENTS-TLS-CERT-SERVICE-CONN_kv_access_policy" {
