...
module "pagopa-biz-events-datastore-service_code_review" {
  source = "git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_code_review?ref=v2.2.0"
  count  = var.pagopa-biz-events-datastore-service.pipeline.enable_code_review == true ? 1 : 0
  ...
  variables = merge(
    ...
    local.pagopa-biz-events-datastore-service-variables_code_review,
  )

  variables_secret = merge(
    local.pagopa-biz-events-datastore-service-variables_secret,
    local.pagopa-biz-events-datastore-service-variables_secret_code_review,
  )
...
module "pagopa-biz-events-datastore-service_deploy" {
  source = "git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_deploy?ref=v2.2.0"
  count  = var.pagopa-biz-events-datastore-service.pipeline.enable_deploy == true ? 1 : 0
  ...
  variables = merge(
    local.pagopa-biz-events-datastore-service-variables,
    local.pagopa-biz-events-datastore-service-variables_deploy,
    local.pagopa-biz-events-datastore-variables_integration_test,
  )
