...
locals {
  ...
  # 🔐 KV DOMAIN
  dev_apiconfig_key_vault_name  = "${local.prefix}-d-${local.domain}-kv"
  uat_apiconfig_key_vault_name  = "${local.prefix}-u-${local.domain}-kv"
  prod_apiconfig_key_vault_name = "${local.prefix}-p-${local.domain}-kv"

  dev_apiconfig_key_vault_resource_group  = "${local.prefix}-d-${local.domain}-sec-rg"
  uat_apiconfig_key_vault_resource_group  = "${local.prefix}-u-${local.domain}-sec-rg"
  prod_apiconfig_key_vault_resource_group = "${local.prefix}-p-${local.domain}-sec-rg"
