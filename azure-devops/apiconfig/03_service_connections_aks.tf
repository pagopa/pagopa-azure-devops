...
#   apiserver_url         = module.apiconfig_uat_secrets.values["pagopa-u-weu-uat-aks-apiserver-url"].value
#   authorization_type    = "ServiceAccount"
#   service_account {
#     # base64 values
#     token   = module.apiconfig_uat_secrets.values["pagopa-u-weu-uat-aks-azure-devops-sa-token"].value
#     ca_cert = module.apiconfig_uat_secrets.values["pagopa-u-weu-uat-aks-azure-devops-sa-cacrt"].value
#   }
# }
...
#   apiserver_url         = module.apiconfig_prod_secrets.values["pagopa-p-weu-prod-aks-apiserver-url"].value
#   authorization_type    = "ServiceAccount"
#   service_account {
#     # base64 values
#     token   = module.apiconfig_prod_secrets.values["pagopa-p-weu-prod-aks-azure-devops-sa-token"].value
#     ca_cert = module.apiconfig_prod_secrets.values["pagopa-p-weu-prod-aks-azure-devops-sa-cacrt"].value
#   }
# }
