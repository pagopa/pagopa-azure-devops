...
| <a name="module_pagopa-api-config-selfcare-integration-service_code_review"></a> [pagopa-api-config-selfcare-integration-service\_code\_review](#module\_pagopa-api-config-selfcare-integration-service\_code\_review) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_code_review | v5.1.1 |
...
| <a name="module_pagopa_api_config-cache_code_review"></a> [pagopa\_api\_config-cache\_code\_review](#module\_pagopa\_api\_config-cache\_code\_review) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_code_review | v5.1.1 |
| <a name="module_pagopa_api_config_code_review"></a> [pagopa\_api\_config\_code\_review](#module\_pagopa\_api\_config\_code\_review) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_code_review | v5.1.1 |
