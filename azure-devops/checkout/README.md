...
| <a name="module_pagopa-checkout-fe_npg_sdk_sync"></a> [pagopa-checkout-fe\_npg\_sdk\_sync](#module\_pagopa-checkout-fe\_npg\_sdk\_sync) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_generic | v4.2.1 |
