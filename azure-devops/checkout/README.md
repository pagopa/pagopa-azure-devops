...
| <a name="module_ecommerce_dev_secrets"></a> [ecommerce\_dev\_secrets](#module\_ecommerce\_dev\_secrets) | git::https://github.com/pagopa/terraform-azurerm-v3.git//key_vault_secrets_query | v8.42.3 |
...
| <a name="module_pagopa-checkout-fe_npg_sdk_sync"></a> [pagopa-checkout-fe\_npg\_sdk\_sync](#module\_pagopa-checkout-fe\_npg\_sdk\_sync) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_deploy | v4.2.1 |
...
| <a name="input_pagopa-checkout-fe"></a> [pagopa-checkout-fe](#input\_pagopa-checkout-fe) | n/a | `map` | <pre>{<br/>  "pipeline": {<br/>    "enable_code_review": true,<br/>    "enable_deploy": true,<br/>    "enable_npg_sdk_sync": true<br/>  },<br/>  "repository": {<br/>    "branch_name": "refs/heads/main",<br/>    "name": "pagopa-checkout-fe",<br/>    "organization": "pagopa",<br/>    "pipelines_path": ".devops",<br/>    "yml_prefix_name": "pagopa"<br/>  }<br/>}</pre> | no |
