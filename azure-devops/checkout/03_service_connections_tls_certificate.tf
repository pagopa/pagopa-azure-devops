...
# DEV
#
module "DEV-CHECKOUT-TLS-CERT-SERVICE-CONN" {
...
resource "azurerm_key_vault_access_policy" "DEV-CHECKOUT-TLS-CERT-SERVICE-CONN_kv_access_policy" {
  provider     = azurerm.dev
  key_vault_id = data.azurerm_key_vault.domain_kv_dev.id
  tenant_id    = data.azurerm_client_config.current.tenant_id
  object_id    = module.DEV-CHECKOUT-TLS-CERT-SERVICE-CONN.service_principal_object_id
...
module "UAT-CHECKOUT-TLS-CERT-SERVICE-CONN" {
  providers = {
    azurerm = azurerm.uat
  }
...
resource "azurerm_key_vault_access_policy" "UAT-CHECKOUT-TLS-CERT-SERVICE-CONN_kv_access_policy" {
  provider     = azurerm.uat
  key_vault_id = data.azurerm_key_vault.domain_kv_uat.id
  tenant_id    = data.azurerm_client_config.current.tenant_id
  object_id    = module.UAT-CHECKOUT-TLS-CERT-SERVICE-CONN.service_principal_object_id
...
module "PROD-CHECKOUT-TLS-CERT-SERVICE-CONN" {
  providers = {
...
resource "azurerm_key_vault_access_policy" "PROD-CHECKOUT-TLS-CERT-SERVICE-CONN_kv_access_policy" {
  provider     = azurerm.prod
  key_vault_id = data.azurerm_key_vault.domain_kv_prod.id
  tenant_id    = data.azurerm_client_config.current.tenant_id
  object_id    = module.PROD-CHECKOUT-TLS-CERT-SERVICE-CONN.service_principal_object_id
