...
locals {
  ...
  pagopa-afm-calculator-service-variables_secret_performance_test = {
    DEV_COSMOS_SUBSCRIPTION_KEY = module.afm_dev_secrets.values["afm_marketplace_cosmos_pkey"].value
    UAT_COSMOS_SUBSCRIPTION_KEY = module.afm_uat_secrets.values["afm_marketplace_cosmos_pkey"].value
  }
