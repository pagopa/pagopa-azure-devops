...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_DEV-printit-TLS-CERT-SERVICE-CONN"></a> [DEV-printit-TLS-CERT-SERVICE-CONN](#module\_DEV-printit-TLS-CERT-SERVICE-CONN) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_serviceendpoint_federated | v4.2.1 |
| <a name="module_PROD-printit-TLS-CERT-SERVICE-CONN"></a> [PROD-printit-TLS-CERT-SERVICE-CONN](#module\_PROD-printit-TLS-CERT-SERVICE-CONN) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_serviceendpoint_federated | v4.2.1 |
| <a name="module_UAT-printit-TLS-CERT-SERVICE-CONN"></a> [UAT-printit-TLS-CERT-SERVICE-CONN](#module\_UAT-printit-TLS-CERT-SERVICE-CONN) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_serviceendpoint_federated | v4.2.1 |
...
| <a name="module_letsencrypt_dev"></a> [letsencrypt\_dev](#module\_letsencrypt\_dev) | git::https://github.com/pagopa/terraform-azurerm-v3.git//letsencrypt_credential | v7.67.1 |
| <a name="module_letsencrypt_prod"></a> [letsencrypt\_prod](#module\_letsencrypt\_prod) | git::https://github.com/pagopa/terraform-azurerm-v3.git//letsencrypt_credential | v7.67.1 |
| <a name="module_letsencrypt_uat"></a> [letsencrypt\_uat](#module\_letsencrypt\_uat) | git::https://github.com/pagopa/terraform-azurerm-v3.git//letsencrypt_credential | v7.67.1 |
| <a name="module_pagopa-printit-service_code_review"></a> [pagopa-printit-service\_code\_review](#module\_pagopa-printit-service\_code\_review) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_code_review | v5.1.1 |
| <a name="module_pagopa-printit-service_deploy"></a> [pagopa-printit-service\_deploy](#module\_pagopa-printit-service\_deploy) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_deploy | v4.2.1 |
| <a name="module_pagopa-printit-tests_soak"></a> [pagopa-printit-tests\_soak](#module\_pagopa-printit-tests\_soak) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_generic | v4.2.1 |
...
| <a name="module_tlscert-weudev-printit-internal-dev-platform-pagopa-it-cert_az"></a> [tlscert-weudev-printit-internal-dev-platform-pagopa-it-cert\_az](#module\_tlscert-weudev-printit-internal-dev-platform-pagopa-it-cert\_az) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_tls_cert_federated | v5.0.0 |
| <a name="module_tlscert-weuprod-printit-internal-prod-platform-pagopa-it-cert_az"></a> [tlscert-weuprod-printit-internal-prod-platform-pagopa-it-cert\_az](#module\_tlscert-weuprod-printit-internal-prod-platform-pagopa-it-cert\_az) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_tls_cert_federated | v5.0.0 |
| <a name="module_tlscert-weuuat-printit-internal-uat-platform-pagopa-it-cert_az"></a> [tlscert-weuuat-printit-internal-uat-platform-pagopa-it-cert\_az](#module\_tlscert-weuuat-printit-internal-uat-platform-pagopa-it-cert\_az) | git::https://github.com/pagopa/azuredevops-tf-modules.git//azuredevops_build_definition_tls_cert_federated | v5.0.0 |
...
| <a name="input_pagopa-printit-service"></a> [pagopa-printit-service](#input\_pagopa-printit-service) | n/a | `map` | <pre>{<br>  "pipeline": {<br>    "enable_code_review": true,<br>    "enable_deploy": true,<br>    "sonarcloud": {<br>      "org": "pagopa",<br>      "project_key": "pagopa_pagopa-printit-service",<br>      "project_name": "pagopa-printit-service",<br>      "service_connection": "SONARCLOUD-SERVICE-CONN"<br>    }<br>  },<br>  "repository": {<br>    "branch_name": "refs/heads/main",<br>    "name": "pagopa-printit-service",<br>    "organization": "pagopa",<br>    "pipelines_path": ".devops",<br>    "yml_prefix_name": null<br>  }<br>}</pre> | no |
| <a name="input_pagopa-printit-tests"></a> [pagopa-printit-tests](#input\_pagopa-printit-tests) | n/a | `map` | <pre>{<br>  "pipeline": {<br>    "enable_soak": true,<br>    "name": "soak-test-pipeline"<br>  },<br>  "repository": {<br>    "branch_name": "refs/heads/main",<br>    "name": "pagopa-printit-tests",<br>    "organization": "pagopa",<br>    "pipeline_yml_filename": "soaktest.yaml",<br>    "pipelines_path": ".devops",<br>    "yml_prefix_name": null<br>  }<br>}</pre> | no |
