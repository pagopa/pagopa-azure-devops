...
#      dns_zone_resource_group = "pagopa-p-itn-printit-itn-sec-rg"
...
#  credential_key_vault_name            = local.dev_printit-itn_key_vault_name
#  credential_key_vault_resource_group  = local.dev_printit-itn_key_vault_resource_group
