locals {
  ...
  dev_crusc8_key_vault_name  = "${local.prefix}-d-${local.location_short}-${local.domain}-kv"
  uat_crusc8_key_vault_name  = "${local.prefix}-u-${local.location_short}-${local.domain}-kv"
  prod_crusc8_key_vault_name = "${local.prefix}-p-${local.location_short}-${local.domain}-kv"

  dev_key_vault_resource_group  = "${local.prefix}-d-sec-rg"
  uat_key_vault_resource_group  = "${local.prefix}-u-sec-rg"
  prod_key_vault_resource_group = "${local.prefix}-p-sec-rg"

  dev_crusc8_key_vault_resource_group  = "${local.prefix}-d-${local.location_short}-${local.domain}-sec-rg"
  uat_crusc8_key_vault_resource_group  = "${local.prefix}-u-${local.location_short}-${local.domain}-sec-rg"
  prod_crusc8_key_vault_resource_group = "${local.prefix}-p-${local.location_short}-${local.domain}-sec-rg"
